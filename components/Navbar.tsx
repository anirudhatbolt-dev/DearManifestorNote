          ...
          <div className="flex items-center">
            {loading ? (
              ...
              <div className="flex items-center gap-4">
                <Link
                  href="/gallery"
                  className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#3D3331] text-white hover:opacity-90 transition-opacity"
                >
                  <Image className="w-4 h-4" />
                  <span className="text-sm font-medium font-[family-name:var(--font-poppins)]">Gallery</span>
                </Link>
                <DropdownMenu>
